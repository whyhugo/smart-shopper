...
var BootSceneEnd = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootSceneEnd ()
    {
        Phaser.Scene.call(this, { key: 'BootSceneEnd' });
    },
    ...
    create: function ()
    {
        // start the WorldSceneEnd
        this.scene.start('WorldSceneEnd');
    }
});

var WorldSceneEnd = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldSceneEnd ()
    {
        Phaser.Scene.call(this, { key: 'WorldSceneEnd' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(10000, function() {
            this.scene.start('BootSceneStart');
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
            notfruit = 0;  // switch to Scene2
        }, [], this);
    },
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 30, '恭喜！你已經成為採買達人～', {
            font: '18px Arial',
            fill: '#fff'
        });
