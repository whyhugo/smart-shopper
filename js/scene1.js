...
var BootScene1 = new Phaser.Class({
    ...
    function BootScene1 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene1' });
    },
    ...
    create: function ()
    {
        // start the WorldScene1
        this.scene.start('WorldScene1');
    }
});

var WorldScene1 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene1 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene1' });
    },
    ...
    collectApple: function (player, apple) {
        ...
        red += 1;
        if (fruit >= 3) {
            this.scene.start('BootScene12');  // switch to Scene2
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 20, '第一關\n請蒐集 3 個任意水果', {
            font: '12px Arial',
            fill: '#fff'
        });
