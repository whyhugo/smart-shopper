...
var BootScene10 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene10 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene10' });
    },
    ...
    create: function ()
    {
        // start the WorldScene10
        this.scene.start('WorldScene10');
    }
});

var WorldScene10 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene10 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene10' });
    },
    ...
    collectBroccoli: function (player, broccoli) {
        ...
        vegetables += 1;
        notfruit += 1;
        if (fruit == 1 && protein == 2 && vegetables == 3) {
            this.scene.start('BootSceneEnd');  // switch to Scene2
        } else if (fruit > 1 || protein > 2 || vegetables > 3) {
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 20, '第十關\n請蒐集 1 個水果 & 2 個蛋豆魚肉 & 3 個蔬菜', {
            font: '12px Arial',
            fill: '#fff'
        });
