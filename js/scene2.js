...
var BootScene2 = new Phaser.Class({
    ...
    function BootScene2 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene2' });
    },
...
var WorldScene2 = new Phaser.Class({
    ...
    collectBroccoli: function (player, broccoli) {
        ...
        notfruit += 1;
        if (vegetables >= 5) {
            this.scene.start('BootScene23');  // switch to Scene2
  ...
  // increment vegetables count
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 20, '第二關\n請蒐集 5 個任意蔬菜', {
            font: '12px Arial',
            fill: '#fff'
        });
