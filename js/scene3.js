...
var BootScene3 = new Phaser.Class({
    ...
    function BootScene3 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene3' });
    },
    ...
    create: function ()
    {
        // start the WorldScene3
        this.scene.start('WorldScene3');
    }
});

var WorldScene3 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene3 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene3' });
    },
    ...
    collectEggs: function (player, eggs) {
        ...
        notfruit += 1;
        if (protein >= 4) {
            this.scene.start('BootScene34');  // switch to Scene2
   ...
   // increment vegetables count
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 20, '第三關\n請蒐集 4 個任意蛋豆魚肉類食物', {
            font: '12px Arial',
            fill: '#fff'
        });
