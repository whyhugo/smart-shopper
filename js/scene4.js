...
var BootScene4 = new Phaser.Class({
    ...
    function BootScene4 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene4' });
    },
    ...
    create: function ()
    {
        // start the WorldScene4
        this.scene.start('WorldScene4');
    }
});

var WorldScene4 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene4 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene4' });
    },
    ...
    collectBroccoli: function (player, broccoli) {
        ...
        notfruit += 1;
        if (notfruit >= 8) {
            this.scene.start('BootScene45');  // switch to Scene2
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 20, '第四關\n請蒐集 8 個「水果以外」的食物', {
            font: '12px Arial',
            fill: '#fff'
        });
