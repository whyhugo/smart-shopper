...
var BootScene6 = new Phaser.Class({
    ...
    function BootScene6 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene6' });
    },
    ...
    create: function ()
    {
        // start the WorldScene6
        this.scene.start('WorldScene6');
    }
});

var WorldScene6 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene6 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene6' });
    },
