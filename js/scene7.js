...
var BootScene7 = new Phaser.Class({
    ...
    function BootScene7 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene7' });
    },
    ...
    create: function ()
    {
        // start the WorldScene7
        this.scene.start('WorldScene7');
    }
});

var WorldScene7 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene7 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene7' });
    },
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 25, '第七關\n蒐集 1 個蔬果\n「與屏東落山風息息相關」', {
            font: '12px Arial',
            fill: '#fff'
        });
