...
var BootScene8 = new Phaser.Class({
    ...
    function BootScene8 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene8' });
    },
    ...
    create: function ()
    {
        // start the WorldScene8
        this.scene.start('WorldScene8');
    }
});

var WorldScene8 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene8 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene8' });
    },
    ...
    collectOrange: function (player, orange) {
        ...
        fruit += 1;
        this.scene.start('BootScene89');  // increment vegetables count
    },
    ...
    addLevelText: function() {
        ...
        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 25, '第八關\n請蒐集 1 個蔬果\n「象徵大吉大利」', {
            font: '12px Arial',
            fill: '#fff'
        });
