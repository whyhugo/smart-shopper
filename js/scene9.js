...
var BootScene9 = new Phaser.Class({
    ...
    function BootScene9 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene9' });
    },
    ...
    create: function ()
    {
        // start the WorldScene9
        this.scene.start('WorldScene9');
    }
});

var WorldScene9 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene9 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene9' });
    },
    ...
    collectBroccoli: function (player, broccoli) {
        ...
        vegetables += 1;
        notfruit += 1;  // increment vegetables count
    ...
    collectMeat: function (player, meat) {
        ...
        protein += 1;
        notfruit += 1;
        red += 1;  // increment vegetables count
        this.scene.start('BootSceneRestart');
    },
    ...
    collectCoconut: function (player, coconut) {
        ...
        fruit += 1;
        this.scene.start('BootScene910');  // increment vegetables count
    },
    ...
    addLevelText: function() {
        ...
        graphics.fillRect(0, 0, this.cameras.main.width, 50); // position and size of the background

        // create the text
        var levelText = this.add.text(this.cameras.main.width / 2, 25, '第九關\n蒐集 1 個蔬果\n「高高樹，結水罐，不用人灌，自己滿」', {
            font: '12px Arial',
            fill: '#fff'
        });
