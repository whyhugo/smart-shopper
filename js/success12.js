...
var BootScene12 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene12 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene12' });
    },
    ...
    create: function ()
    {
        // start the WorldScene12
        this.scene.start('WorldScene12');
    }
});

var WorldScene12 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene12 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene12' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene2');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
