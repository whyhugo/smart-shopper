...
var BootScene23 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene23 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene23' });
    },
    ...
    create: function ()
    {
        // start the WorldScene23
        this.scene.start('WorldScene23');
    }
});

var WorldScene23 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene23 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene23' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene3');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
