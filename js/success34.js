...
var BootScene34 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene34 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene34' });
    },
    ...
    create: function ()
    {
        // start the WorldScene34
        this.scene.start('WorldScene34');
    }
});

var WorldScene34 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene34 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene34' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene4');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
