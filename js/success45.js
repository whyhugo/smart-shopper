...
var BootScene45 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene45 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene45' });
    },
    ...
    create: function ()
    {
        // start the WorldScene45
        this.scene.start('WorldScene45');
    }
});

var WorldScene45 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene45 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene45' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene5');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
