...
var BootScene56 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene56 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene56' });
    },
    ...
    create: function ()
    {
        // start the WorldScene56
        this.scene.start('WorldScene56');
    }
});

var WorldScene56 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene56 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene56' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene6');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
