...
var BootScene67 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene67 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene67' });
    },
    ...
    create: function ()
    {
        // start the WorldScene67
        this.scene.start('WorldScene67');
    }
});

var WorldScene67 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene67 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene67' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene7');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
