...
var BootScene78 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene78 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene78' });
    },
    ...
    create: function ()
    {
        // start the WorldScene78
        this.scene.start('WorldScene78');
    }
});

var WorldScene78 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene78 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene78' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene8');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
