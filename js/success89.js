...
var BootScene89 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function BootScene89 ()
    {
        Phaser.Scene.call(this, { key: 'BootScene89' });
    },
    ...
    create: function ()
    {
        // start the WorldScene89
        this.scene.start('WorldScene89');
    }
});

var WorldScene89 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function WorldScene89 ()
    {
        Phaser.Scene.call(this, { key: 'WorldScene89' });
    },
    ...
    create: function ()
    {
        ...
        this.time.delayedCall(2000, function() {
            this.scene.start('BootScene9');  // switch to Scene2
            vegetables = 0;
            protein = 0;
            fruit = 0;
            red = 0;
